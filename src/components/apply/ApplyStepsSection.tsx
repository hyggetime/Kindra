...
export function ApplyStepsSection() {
  return (
    <details className="group mt-8 scroll-mt-24 rounded-2xl border border-[#E8E4DC] bg-white shadow-sm open:shadow-md">
      ...
      <div className="border-t border-[#F0EBE3] px-5 pb-7 pt-2 sm:px-7 sm:pb-8" id="apply-steps">
