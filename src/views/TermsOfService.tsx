      ...
      <main className="mx-auto max-w-3xl px-5 py-14 sm:py-20">
        ...
        <Section title="제4조 (서비스의 제공 및 변경)">
          <ul className="ml-4 list-disc space-y-2">
            ...
            <li>
              ...
              회사는 신청 시 기재한 이메일로 통합 리포트를 발송합니다. <strong>{REPORT_EMAIL_DELIVERY_POLICY_FORMAL}</strong>{' '}
              동시 접수, 결제·입금 확인 지연, 기술적 사유 등으로 안내 또는 발송이 그보다 늦어질 수 있습니다.
            </li>
        ...
        <Section title="제9조 (개인정보 보호)">
          <p>
            ...
            자세한 내용은{' '}
            <Link href="/privacy" className="font-medium text-[#7C9070] underline hover:text-[#4F6048]">
              개인정보처리방침
            </Link>
            을 확인하시기 바랍니다.
          </p>
